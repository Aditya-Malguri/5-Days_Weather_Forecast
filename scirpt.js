...
const getCityCoordinates= () => {
    ...
    const geourl = `http://api.openweathermap.org/geo/1.0/direct?q=${cityName}&limit=5&appid=${API_key}`;
    ...
    navigator.geolocation.getCurrentPosition(
        ...
        error => {
            if(error.code === error.PERMISSION_DENIED){
                alert("Geolocation request denied. Please rest location permission to grant access again.");
            }
        }
    )
}
